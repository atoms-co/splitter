...
func newTCPTransport(bindAddr string,
	...
	// TODO(jhhurwitz): 08/03/2023 Do something better than forking raft.NewTCPTransportWithLogger.
	// For now, we need to fork and remove the check addr.IP.IsUnspecified() which doesn't play nice with 0.0.0.0
	// a requirement of Istio/Envoy. https://github.com/hashicorp/raft/issues/438
	if addr.IP == nil {
		list.Close()
