...
func InvokeEx[T, K, A, B any](ctx context.Context, p model.SimpleResolver[T, K], key K, fn func(T, context.Context, A, ...grpc.CallOption) (B, error), a A, local func() (B, error)) (B, error) {
...
func InvokeExZero[T, A, B any](ctx context.Context, p model.SimpleResolver[T, model.DomainKey], fn func(T, context.Context, A, ...grpc.CallOption) (B, error), a A, local func() (B, error)) (B, error) {
